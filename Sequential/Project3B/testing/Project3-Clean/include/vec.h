 ...
 *
 * Description:
 * Generic dynamic vector class for holding numerical arrays and performing
 *  arithmetic. Code is adapted from Press et al. Numerical Recipes NRvector
 * class and from the following stackoverflow.com posts:
...
public:
  ...
  void assign_to(const vec &source, int _DIM) {
    for (int i = 0; i < _DIM; ++i) {
